...
def parse_arguments():
    ...
    if day not in weekdays:
        sys.exit("Please enter a valid day, i.e. " + str(weekdays))
    try:
        datetime.strptime(time, '%H:%M')
    except ValueError:
        sys.exit("Please enter a valid time between 00:00 and 23:59")

    # Timestamp the output file. Assuming ":" is not allowed in file names
    output_file_path += "_" + day + "_" + time.replace(":", ".")
